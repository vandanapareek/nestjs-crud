...
export class ProductController {
    ...
    @Get('productsByCategoryName/:category')
    async findAllByCategoryName(@Param('category') category: string, @Query() paginateSortDto: PaginateDto): Promise<any> {
      console.log('pagin ', paginateSortDto, category);
      return this.catService.findAllByCategoryName(category, paginateSortDto);
    }
